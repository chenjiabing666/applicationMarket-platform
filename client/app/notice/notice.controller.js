(function(){
  ...
  function noticeCtrl($scope,$http,$mdDialog,$location,$timeout){
    ...
    function getnoticeList(pageNum, pageSize){
        console.log("cdcd")
        $http.post('http://localhost:8080/applicationMarket-server/' + 'message/getMessageList.do',{},{params:{
            pageNum:pageNum,
            pageSize:pageSize
    ...
    $scope.topNotice=function(id){
        $http.post('http://localhost:8080/applicationMarket-server/' + 'notice/topNotice.do',{},{params:{
                        noticeId:id
                    }}).success(function (data) {
                     if (data.code == 0) {
...
$scope.exportExcel = function(){
                ...
                var url="http://localhost:8080/applicationMarket-server/"+"notice/exportExcel.do?";

                // var modifyTopicUrl ="http://localhost:8080/applicationMarket-server/"+"notice/exportExcel.do";// 接收上传文件的后台地址
...
$scope.deleteList = function(){
                ...
                var modifyTopicUrl ="http://localhost:8080/applicationMarket-server/"+"notice/deletenoticeBatch.do";// 接收上传文件的后台地址
                console.log($scope.selected);
                var temp = "";
       ...
       $scope.searchnotice = function(pageNum,pageSize){
           ...
           $http.post('http://localhost:8080/applicationMarket-server/' + 'notice/getnoticeList.do',{},{params:{
        ...
        $scope.deletenotice = function(id){
            $scope.showConfirm = function() {
                ...
                .title('是否确定删除该条消息')
                            ...
                            $mdDialog.show(confirm).then(function() {
                    // console.log('确定')
                    $http.post("http://localhost:8080/applicationMarket-server/"+"message/delete.do?",{},{params:{
                        messageId:id
                    }}).success(function (data){
                        if(data.code == 0){
    ...
    function noticeDetailCtrl($scope,$http,$location,$mdDialog,$timeout,$sce){
        ...
        // 或者 var editor = new E( document.getElementById('editor') )
            ...
            // editor.customConfig.uploadImgServer = "http://localhost:8080/applicationMarket-server/notice/uploadImage.do"  // 上传图片到服务器
        ...
        //根据逝者id获取逝者详细信息
        $http.post('http://localhost:8080/applicationMarket-server/' + 'message/getMessage.do',{},{params:{
        ...
        $scope.modifyNotice=function(){
                    ...
                    .title('是否确定修改消息')
                                ...
                                .cancel('取消');
                                $mdDialog.show(confirm).then(function() {
            $http.post('http://localhost:8080/applicationMarket-server/' + 'message/modify.do',{},{params:{
            messageId:$scope.noticeId,
    ...
    $scope.closeVideo = function(){
        ...
        function noticechangeCtrl($scope,$http,$location,$mdDialog,$timeout){
            ...
            $scope.searchnotice=function(){
                ...
                $http.post("http://localhost:8080/applicationMarket-server/"+"notice/getUserListByIdOrMobileOrName.do?",{},{params:{
            ...
            $scope.bindingnotice=function(){
                ...
                $http.post("http://localhost:8080/applicationMarket-server/"+"notice/bindingUser.do?",{},{params:{
        ...
        $scope.addnotice=function(){
            ...
            $http.post("http://localhost:8080/applicationMarket-server/"+"message/addMessage.do",{},{params:{
                        title:$scope.title,
                        content:$scope.content,
                    }}).success(function (data){
                        if(data.code == 0){
