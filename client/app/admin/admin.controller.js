(function () {
    ...
    function ChangeAdminCtrl($scope, $http, $mdDialog, $location, $timeout) {
        ...
        $scope.modifyPassword = function () {
            ...
            $http.post('http://localhost:8080/applicationMarket-server/' + 'admin/modifAdmin.do', {}, {
                params: {
    ...
    function AdminCtrl($scope, $http, $mdDialog, $location, $timeout) {
        ...
        function getAdminList(pageNum, pageSize) {
            ...
            $http.post('http://localhost:8080/applicationMarket-server/' + 'admin/getAdminBatch.do', {}, {
                params: {
        ...
        //     $http.post("http://localhost:8080/applicationMarket-server/" + "admin/deleteAdmin.do", {}, {
        //         params: {
        //             adminId: id
        //         }
        //     }).success(function (data) {
    ...
    function AddAdminCtrl($scope, $http, $mdDialog, $location, $timeout) {
        ...
        // 获取权限列表
        // $http.post('http://localhost:8080/applicationMarket-server/' + 'authority/getAuthorityList.do', {}, {
        //     params: {
        //         pageSize: 100,
        //         pageNum: 1
        //     }
        ...
        $scope.addAdmin = function () {
            ...
            $scope.showConfirm = function () {
                ...
                $mdDialog.show(confirm).then(function () {
                    ...
                    $http.post("http://localhost:8080/applicationMarket-server/" + "admin/addAdmin.do?", {}, {
                        params: {
                            email: $scope.admin.email,
